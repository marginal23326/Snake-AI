...
impl TrainerOptions {
    ...
    pub const DEFAULT_ONLY_HTTP_FLAG: u8 = 0;
    pub const DEFAULT_HTTP_GAMES_OVERRIDE: usize = 0;
    pub const DEFAULT_SELF_PLAY_FLAG: u8 = 0;
    ...
    pub const DEFAULT_STAGED_EVAL_FLAG: u8 = 1;
    ...
    pub const DEFAULT_VERIFY_FLAG: u8 = 1;
    ...
    pub const DEFAULT_LEGACY_HTTP_FLAG: u8 = 0;
...
impl Default for TrainerOptions {
    fn default() -> Self {
        Self {
            ...
            only_http: Self::DEFAULT_ONLY_HTTP_FLAG != 0,
            http_games: Self::DEFAULT_GAMES,
            self_play: Self::DEFAULT_SELF_PLAY_FLAG != 0,
            ...
            staged_eval: Self::DEFAULT_STAGED_EVAL_FLAG != 0,
            ...
            verify: Self::DEFAULT_VERIFY_FLAG != 0,
            ...
            legacy_http: Self::DEFAULT_LEGACY_HTTP_FLAG != 0,
            resume: None,
            checkpoint: None,
        }
    }
